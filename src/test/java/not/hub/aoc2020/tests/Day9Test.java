...
class Day9Test {
    ...
    private static final List<BigInteger> example = InputParser.bigIntegerList("inputs/day9_example");
    private static final List<BigInteger> input = InputParser.bigIntegerList("inputs/day9");

    @Test
    @DisplayName("Part 1 - Example")
    void part1_example(TestInfo info) {
        AssertWrapper.equals(new BigInteger(String.valueOf(127)), new EncodingError1().solve(example, 5), info);
    }

    @Test
    @DisplayName("Part 1 - Input")
    void part1_input(TestInfo info) {
        AssertWrapper.equals(new BigInteger(String.valueOf(14144619)), new EncodingError1().solve(input, 25), info);
    }
