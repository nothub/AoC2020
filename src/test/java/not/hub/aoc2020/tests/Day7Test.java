...
class Day7Test {
    ...
    void part1_example1(TestInfo info) {
        Util.test(4, new HandyHaversacks1().solve(example1), info);
    }

    @Test
    @DisplayName("Part 1 - Input")
    void part1_input(TestInfo info) {
        Util.test(213, new HandyHaversacks1().solve(input), info);
    }

    @Test
    @DisplayName("Part 2 - Example 1")
    void part2_example1(TestInfo info) {
        Util.test(32, new HandyHaversacks2().solve(example1), info);
    }

    @Test
    @DisplayName("Part 2 - Example 2")
    void part2_example2(TestInfo info) {
        Util.test(126, new HandyHaversacks2().solve(example2), info);
    }

    @Test
    @DisplayName("Part 2 - Input")
    void part2_input(TestInfo info) {
        Util.test(38426, new HandyHaversacks2().solve(input), info);
    }
